...
const Authentication = () =>{
	...
	const apiUrl = isLogin ? '/auth/login' : '/auth/person'
	...
	useEffect(()=>{
		...
		console.log('token пробуем111111111', response)
		initToken()
		rest1.getUser()
			.then(item =>{ 
				...
				.catch(item => console.log ('catched ', item))
        ...
        <div className ="container-login100">
			...
			{/* <h1 className = 'text-xs-center' >{pageTitle}</h1> */}
                ...
                onSubmit = {handleSubmit}>
					...
					{!isLogin  && (<div className ="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
									<input 
									...
									/>
										<span className ="focus-input100"></span>
											<span className ="sy mbol-input100">
